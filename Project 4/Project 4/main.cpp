...
////	nameToGPA.associate("David", 4.0); // Carey deserves a 4.0
...
////	GeoCoord lookMeUp("34.0630614", "-118.4468781");
...
////				 // by iterating thru all segments from the MapLoader object
////	GeoCoord fillMe;
////	string attraction = "ackerman unIoN";
...
//{
//	Navigator bruin;
//	bruin.loadMapData("mapdata.txt");
//
//	vector<NavSegment> directions;
//	bruin.navigate("1061 Broxton Avenue", "HeaDlines!", directions);
...
//	/*MapLoader mapL;
//	mapL.load("mapdata.txt");
//	example(mapL);*/
//	/*Navigator nav;
//	vector <NavSegment> navSeg;
//	nav.loadMapData("mapdata.txt");
//	nav.navigate("ackerman unIoN", "Diddy Riese", navSeg);*/
//	return 0;
//}
